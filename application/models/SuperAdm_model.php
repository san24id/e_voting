...
class SuperAdm_model extends CI_model {
    ...
    function addstaff($add){
        $sql = "INSERT INTO `m_user`(id_user, username, password, display_name, role_id, division_id, created_by, created_date, role_status, email, status, status_1, status_mail1, status_mail2) 
        VALUES ('".$add['id_user']."','".$add['username']."',md5('".$add['password']."'),'".$add['display_name']."','".$add['role_id']."','".$add['division_id']."',
