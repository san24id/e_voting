...
class Home_model extends CI_Model{   
    ...
    function updatepayment($upd){
        $sql = "UPDATE `t_payment` SET `display_name`='".$upd['display_name']."',`jabatan`='".$upd['jabatan']."',`jenis_pembayaran`='".$upd['jenis_pembayaran']."',`currency`='".$upd['currency']."',`currency2`='".$upd['currency2']."',`currency3`='".$upd['currency3']."',
