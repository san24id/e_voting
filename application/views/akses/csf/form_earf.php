                  ...
                  <div class="box-header with-border">
                    ...
                    <table border="1" style="font-family: calibri;" width="100%">
                        ...
                        <tr>
                          ...
                          <td><input id="ulang" style="text-align:right" type="text" class="form-control" name="total_expenses" value="<?php echo $get->total_expenses;?>" readpn;y> </td>
                        </tr>
                        <tr> 
                          <td>Terbilang/ <i>Say :</i> </td>
                          <td colspan="4"><input id="terbilang" type="text" name="terbilang" class="form-control" value="<?php echo $get->terbilang;?>" readonly></td>
                        </tr>
                        <tr> 
...
function saveapf() {
  ...
  $.ajax({
    ...
    success: function(data){ // Ketika proses pengiriman berhasil          
      ...
      console.log(data);
	window.location = "<?php echo base_url('Dashboard/form_varf')?>/" + $id;   
