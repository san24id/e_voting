                  ...
                  <div class="box-header with-border">
                    ...
                    <table style="font-family: calibri;" width="100%">
                      <tbody>     
                        <tr>
                          ...
                          <td><input type="text" name="apf_doc" class="form-control" value="<?php echo $get->arf_doc; ?>" readonly></td>
                        </tr>
                        <tr>
                    ...
                    <table border="1" style="font-family: calibri;" width="100%">
                        ...
                        <tr> 
                          ...
                          <td colspan="4"><input type="text" name="terbilang" class="form-control" placeholder="Terbilang" value="<?php echo $get->terbilang;?>"></td>
                        </tr>
                        <tr> 
