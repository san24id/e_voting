  ...
  text-align: left;
      ...
      <div class="content-wrapper">
        ...
        <form id="formadd" action="#">
          ...
          <input type="hidden" name="jenis_pembayaran" class="form-control" value="2"> 
                  ...
                  <div class="box-header with-border">
                    ...
                    <tbody>
                        ...
                        <tr>
                          ...
                          <td><input type="text" name="apf_doc" class="form-control" value="<?php echo $arf_doc; ?>" readonly></td>
                        ...
                        <tr>
                          ...
                          <td><input type="text" name="tanggal_selesai" class="form-control" value="<?php echo date("d-M-Y", strtotime($row->label3));?>" required readonly></td>
                        </tr>
                      </tbody>
                    </table>
                    ...
                    <table border="1" style="font-family: calibri;" width="100%">
                      ...
                      <tbody>                      
                        ...
                        <tr>
                          ...
                          <td><input id="nilai1" style="text-align:right" onkeyup="nominal()" type="text" class="form-control" name="jumlah2"  ></td> 
                        </tr>
                        <tr>
                          ...
                          <td><input id="nilai2" style="text-align:right" onkeyup="nominal()" type="text" class="form-control" name="jumlah3" ></td> 
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td><input id="nilai4" style="text-align:right" onkeyup="nominal()" type="text" class="form-control" name="jumlah5" value="<?php echo $row->jumlah2;?>"> </td> 
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td><input id="nilai8" style="text-align:right" onkeyup="nominal()" type="text" class="form-control" name="jumlah9" value="<?php echo $row->jumlah3;?>"></td> 
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td><input id="curr1X" style="text-align:center" class="form-control" value="<?php echo $row->currency;?>" readonly> 
                              <input id="curr2X" style="text-align:center" class="form-control" value="<?php echo $row->currency2;?>" readonly> 
                              <input id="curr3X" style="text-align:center" class="form-control" value="<?php echo $row->currency3;?>" readonly> 
                          </td>
    ...
    $.ajax({
        ...
        success: function(data)
        {
			...
			//$(data).each(function(index, value){ 
				...
				//alert(data[index].mata_uang);	
				//});
			/*muncul=data[0].mata_uang; 
			muncul2=data[1].mata_uang; 
			muncul3=data[2].mata_uang; 
			*/
        },
        error: function (data)
        {
