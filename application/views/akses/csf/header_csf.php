        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="assets/admin/dist/img/profile24.png" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $this->session->userdata("display_name"); ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="assets/admin/dist/img/profile24.png" class="img-circle" alt="User Image">
    ...
    <section class="sidebar" >
      ...
      <ul class="sidebar-menu">        
        ...
        <?php 
          ...
          // var_dump($row);exit;
         if($this->session->userdata("role_id") == 4){ ?>
        <li><center><button type="button" data-toggle="modal" data-target="#activate" class="btn btn-success"><i class="glyphicon glyphicon-wrench"></i>&nbsp;ONLINE APPROVAL <br> <?php echo $row->activate;?></button></a></center></li>
        <?php } ?> 
        <br>
        <br>
        ...
        <li><center><a href="Dashboard/form_add"><button type="button" class="btn btn-success btn-lg"><i class="glyphicon glyphicon-plus"></i>&nbsp;CREATE SP3</button></a></center></li>
        <?php } ?> 
