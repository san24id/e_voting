...
<div class="content-wrapper">
    ...
    <div class="box box-default">
        ...
        <!--<a href="dashboard/export_asr"><button class="btn btn-success"><i class="fa fa-download"></i>&nbsp;&nbsp;Export</button></a> -->
		&nbsp;&nbsp;&nbsp;
		...
		<button class="btn btn-success" id="btnpdf" onclick="exportpdf()"><i class="fa fa-download"></i>&nbsp;&nbsp;PDF</button>
			...
			<div id="cari" class="collapse">
				<div class="box-body">
					...
					<input type="hidden" id="txtprofile" name="txtprofile" value="3" ></input>
					</form>
				  <!-- /.row -->
				</div>
			</div>
