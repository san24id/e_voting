...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        MONITORING REPORT WAITING FOR PAYMENT
      </h1>
    </section>
          ...
          <div class="box-body">
            ...
            <div class="row">
              ...
              <!-- /.col -->
					...
					<input type="hidden" id="txtprofile" name="txtprofile" value="9" ></input>
			</form>
            <!-- /.row -->
          </div>
        </div>
...
function resetdata()
 ...
 function caridata()
    {
	  url = "<?php echo base_url('dashboard/caridataMonitoring') ?>"; //caridatamonitoringwpaid
      $.ajax({
            url : url,
            type: "POST",
