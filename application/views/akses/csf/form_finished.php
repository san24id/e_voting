                  ...
                  <div class="box-header with-border">
                    ...
                    <table  style="font-family: calibri;" width="90%"; >
                      ...
                      <tr>
                        ...
                        <td colspan="2">&nbsp;</td>
                        <td>&nbsp;</td>
                        <td><input id="uangmuka" style="text-align:right" onchange="penjumlahan()" type="text" class="form-control" name="label8" value="<?php echo $row->label8; ?>" readonly></input> </td>     
						<td>&nbsp;</td>
                        <td><input id="uangmukaa" style="text-align:right" onchange="penjumlahana()" type="text" class="form-control" name="label8a" value="<?php echo $row->label8a; ?>"></input></td>     
						<td>&nbsp;</td>
                        <td><input id="uangmukab" style="text-align:right" onchange="penjumlahanb()" type="text" class="form-control" name="label8b" value="<?php echo $row->label8b; ?>" readonly></input></td>     
                      </tr>
                      <tr>
