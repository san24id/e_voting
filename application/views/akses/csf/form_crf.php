      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
          FORMULIR PENERIMAAN KAS <br> <i> CASH RECEIVED FORM (CRF)</i>
            <small></small>
          </h1>
        </section>
        <!-- Main content -->
              ...
              <div class="col-xs-12">
                ...
                <div class="box">
                  <div class="box-header with-border">
                    <center><h3 class="box-title"><i>FORM CASH RECEIVED FORM (CRF)</i></h3></center>
                  </div>  
                ...
                <div class="box">
                  <div class="box-header with-border">
                    <h3 class="box-title">DETAIL <i> CASH RECEIVED FORM (CRF))</i></h3>
                  </div>  
