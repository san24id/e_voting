...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
                <font color="#00008B"><b>LIST OF ADVANCE REQUEST</b></font>
    ...
    <div class="box box-default">
        ...
        <!--<a href="dashboard/export_ar"><button class="btn btn-success"><i class="fa fa-download"></i>&nbsp;&nbsp;Export</button></a>-->
		&nbsp;&nbsp;&nbsp;
		...
		<button class="btn btn-success" id="btnpdf" onclick="exportpdf()"><i class="fa fa-download"></i>&nbsp;&nbsp;PDF</button>
			...
			<div id="cari" class="collapse">
				<div class="box-body">
					...
					<input type="hidden" id="txtprofile" name="txtprofile" value="2" ></input>
					</form>
				  <!-- /.row -->
				</div>
			</div>
...
<script type="text/javascript"> 
	 function resetdata()
    {
		...
		$('#periode1').val('');
		$('#periode2').val('');
		url = "<?php echo base_url('dashboard/resetMyReport') ?>";
      $.ajax({
            url : url,
            type: "POST",
  ...
  function caridata()
    {
	  url = "<?php echo base_url('dashboard/caridataMyReport') ?>";
      $.ajax({
            url : url,
            type: "POST",
            data: $('#formCari').serialize(),
