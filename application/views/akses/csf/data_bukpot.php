              ...
              <div class="table-responsive">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hapus<?php echo $row->id_bukpot; ?>">Hapus</button>
                  </td>
                </tr>
              <?php } ?>
              </tbody>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Tambah Data Kode Bukpot</h4>
        </div>
        <div class="modal-body">
          <h5>
            <form id="acc" method="post" action="dashboard/addbukpot">
             <table class="table">
                <tr>
                  <th>Nama Objek Pajak</th>
                  <td>:</td>
...
<!-- Modal -->
  <div class="modal fade" id="ubah<?php echo $row->id_bukpot; ?>" role="dialog" aria-hidden="true"  tabindex="-1"  data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Ubah Data Kode Bukpot</h4>
           
        </div>
        <div class="modal-body">
          <h5>
            <form id="ganti" method="post" action="dashboard/updatebukpot">
              <input type="hidden" name="id_bukpot" value="<?php echo $row->id_bukpot; ?> ">
             <table class="table">
             <table class="table">
                <tr>
                  <th>Nama Objek Pajak</th>
                  <td>:</td>
                  <td><input type="text" name="nama_objek_pajak" class="form-control" value="<?php echo $row->nama_objek_pajak; ?>"></td>
                </tr>
                <tr>
                  <th>Kode Objek Pajak</th>
                  <td>:</td>
                  <td><input type="text" name="kode_objek_pajak" class="form-control" value="<?php echo $row->kode_objek_pajak; ?>"></td>
                </tr>
             </table>
          </h5>
        </div>
...
<div class="modal fade" id="hapus<?php echo $row->id_bukpot; ?>" tabindex="-1" role="dialog" aria-hidden="true">
      ...
      $.ajax({        
          ...
          success: function(response){ // Ketika proses pengiriman berhasil          
              $("#tambah").modal('hide'); // Sembunyikan loadingnya   
               location.reload();       
              alert('Create Data Kode Bukpot success')
          }      
      });
    });
      ...
      $.ajax({        
          ...
          success: function(response){ // Ketika proses pengiriman berhasil          
              $("#ubah").modal('hide'); // Sembunyikan loadingnya   
               location.reload();       
              alert('Update Data Kode Bukpot success')
          }      
      });
  });  
      ...
      $.ajax({        
          ...
          success: function(response){ // Ketika proses pengiriman berhasil          
              $("#hapus").modal('hide'); // Sembunyikan loadingnya   
               location.reload();       
              alert('Deleted Data Kode Bukpot success')
          }      
      });
  });  
</script>
