...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        MONITORING REPORT WAITING FOR REVIEW
      </h1>
    </section>
            ...
            <div class="box-body">
              ...
              <div class="box-footer">  
                <div class="form-group">
                  ...
                  <div class='col-md-2'><img src='assets/dashboard/images/legend/icon_reviewer.png'> &nbsp;Waiting For Reviewer</div>	
                </div>  
              </div>
            </div>
            <!-- /.box-body -->
...
function resetdata()
 ...
 function caridata()
    {
	  url = "<?php echo base_url('dashboard/caridataMonitoring') ?>";//caridatamonitoringwreview
      $.ajax({
            url : url,
            type: "POST",
