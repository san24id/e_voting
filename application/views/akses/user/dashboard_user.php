    ...
    <div class="row">        
          ...
          <div class="info-box bg-gray">
            ...
            <?php if ($start_date && $end_date){
              ...
              <a href="<?php echo base_url('Home/all_detail_payment/1/'.$start_date.'/'.$end_date)?>"><span class="info-box-number"><font size='5' color="green"><center> <?php echo $tot_req->totalreq; ?></center></font></span></a>
              <?php } ?>    
          ...
          <div class="info-box bg-gray">
              ...
              <div class="info-box-content bg-gray">
                ...
                <a href="<?php echo base_url('Home/all_detail_payment/2/'.$start_date.'/'.$end_date)?>"><span class="info-box-number"><font size='5' color="green"><center><?php echo $tot_outstanding->outstanding; ?></center></font></span></a>
                <?php } ?>            
          ...
          <div class="info-box bg-gray">
              ...
              <div class="info-box-content bg-gray">
                ...
                <a href="<?php echo base_url('Home/all_detail_payment/3/'.$start_date.'/'.$end_date)?>"><span class="info-box-number"><font size='5' color="green"><center><?php echo $tot_draft->totaldraft; ?></center></font></span></a>
                <?php } ?>            
                ...
                <div class="box-body">
                  <table width="100%"> 
                    ...
                    <tr>
                      ...
                      <td width="12%"><div class="dua"><center><a href="<?php echo base_url('Home/all_detail_payment/7/'.$start_date.'/'.$end_date)?>"><font size='5' color="black"> <?php echo $tot_draft->totdraft; ?> </font> </center></div></a> </td><td> &nbsp; 
                      <?php } ?>   
                      <?php foreach ($draftprint as $draftprint) { ?>                    
                      <td width="12%"><div class="tiga"><center><a href="<?php echo base_url('Home/all_detail_payment/8/'.$start_date.'/'.$end_date)?>"><font size='5' color="black"> <?php echo $draftprint->draftprint; ?> </font></center></div></a> </td> <td> &nbsp;
                      <?php } ?>               
                      <?php foreach ($submit as $submit) { ?>
                      <td width="12%"><div class="empat"><center><a href="<?php echo base_url('Home/all_detail_payment/9/'.$start_date.'/'.$end_date)?>"><font size='5' color="black"> <?php echo $submit->submit; ?> </font> </div></a> </td> <td> &nbsp;
                      <?php } ?>                  
                      <?php foreach ($process as $process) { ?>
                      <td width="12%"><div class="lima"><center><a href="<?php echo base_url('Home/all_detail_payment/10/'.$start_date.'/'.$end_date)?>"><font size='5' color="black"> <?php echo $process->process; ?> </font></center></div></a> </td> <td> &nbsp;
                      <?php } ?>
                      <?php foreach ($verifikasi as $verifikasi) { ?>
                      <td width="12%"><div class="enam"><center><a href="<?php echo base_url('Home/all_detail_payment/11/'.$start_date.'/'.$end_date)?>"><font size='5' color="black"> <?php echo $verifikasi->verifikasi; ?> </font></center></div></a> </td> <td> &nbsp;
                      <?php } ?>
                      <?php foreach ($approval as $approval) { ?>
                      <td width="12%"><div class="tujuh"><center><a href="<?php echo base_url('Home/all_detail_payment/12/'.$start_date.'/'.$end_date)?>"><font size='5' color="white"> <?php echo $approval->approval; ?> </font></center></div></a> </td> <td> &nbsp;
                      <?php } ?>
                      <?php foreach ($paid as $paid) { ?>
                      <td width="12%"><div class="satu"><center><a href="<?php echo base_url('Home/all_detail_payment/13/'.$start_date.'/'.$end_date)?>"><font size='5' color="white"> <?php echo $paid->paid; ?> </font></div></a> </td><td> &nbsp;  
                      <?php } ?>
                    </tr>
                    <tr>   
