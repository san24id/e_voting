                ...
                <div class="box-body">
                  <table width="100%"> 
                    ...
                    <tr>
                      ...
                      <td width="12%"><div class="dua"><center><a href="<?php echo base_url('Home/all_detail_payment/7')?>"><font size='5' color="black"> <?php echo $tot_draft->totdraft; ?> </font> </center></div></a> </td><td> &nbsp; 
                      <?php } ?>   
                      <?php foreach ($draftprint as $draftprint) { ?>                    
                      <td width="12%"><div class="tiga"><center><a href="<?php echo base_url('Home/all_detail_payment/8')?>"><font size='5' color="black"> <?php echo $draftprint->draftprint; ?> </font></center></div></a> </td> <td> &nbsp;
                      <?php } ?>               
                      <?php foreach ($submit as $submit) { ?>
                      <td width="12%"><div class="empat"><center><a href="<?php echo base_url('Home/all_detail_payment/9')?>"><font size='5' color="black"> <?php echo $submit->submit; ?> </font> </div></a> </td> <td> &nbsp;
                      <?php } ?>                  
                      <?php foreach ($process as $process) { ?>
                      <td width="12%"><div class="lima"><center><a href="<?php echo base_url('Home/all_detail_payment/10')?>"><font size='5' color="black"> <?php echo $process->process; ?> </font></center></div></a> </td> <td> &nbsp;
                      <?php } ?>
                      <?php foreach ($verifikasi as $verifikasi) { ?>
                      <td width="12%"><div class="enam"><center><a href="<?php echo base_url('Home/all_detail_payment/11')?>"><font size='5' color="black"> <?php echo $verifikasi->verifikasi; ?> </font></center></div></a> </td> <td> &nbsp;
                      <?php } ?>
                      <?php foreach ($approval as $approval) { ?>
                      <td width="12%"><div class="tujuh"><center><a href="<?php echo base_url('Home/all_detail_payment/12')?>"><font size='5' color="white"> <?php echo $approval->approval; ?> </font></center></div></a> </td> <td> &nbsp;
                      <?php } ?>
                      <?php foreach ($paid as $paid) { ?>
                      <td width="12%"><div class="satu"><center><a href="<?php echo base_url('Home/all_detail_payment/13')?>"><font size='5' color="white"> <?php echo $paid->paid; ?> </font></div></a> </td><td> &nbsp;  
                      <?php } ?>
                    </tr>
                    <tr>   
