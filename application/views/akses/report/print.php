                  ...
                  <div class="box-header with-border">
                    ...
                    <table width="100%">
                      ...
                      <tr>
                        ...
                        <td width="10%" class="kolom" style="text-align:right"><font size="1"><?php echo $row->label2; ?></td>

                        <td width="2%" class="kolom"><font size="1"> <?php echo $row->currency2;?> </td>
                        <td width="10%" class="kolom" style="text-align:right"><font size="1"><?php echo $row->jumlah2; ?></td>

                        <td width="2%" class="kolom"><font size="1"> <?php echo $row->currency3;?> </td>
                        <td width="10%" class="kolom" style="text-align:right"><font size="1"><?php echo $row->jumlah3; ?></td>
                      </tr>
