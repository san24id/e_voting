                    ...
                    <table border="1" width="100%">
                      ...
                      <tbody>                      
                        ...
                        <tr>
                          ...
                          <td><center> </center></td>
                          <td><font size="1" style="text-align:right"><?php echo $get->currency;?>&nbsp;<?php echo $get->cash_advance; ?>
                              <font size="1" style="text-align:right"><?php echo $get->currency4;?>&nbsp;<?php echo $get->cash_advance2; ?>
                              <font size="1" style="text-align:right"><?php echo $get->currency8;?>&nbsp;<?php echo $get->cash_advance3; ?>
                          </td>
                        </tr>
                        <tr>
                          <td colspan="3"><font size="1"> (Negatif) = Piutang/<i>Receivable</i> atau Positif = Hutang/<i>Payable</i> </td>
                          <td><center> </center></td>
                          <td><font size="1" style="text-align:right"><?php echo $get->currency;?>&nbsp;<?php echo $get->piutang; ?>  
                        ...
                        <tr> 
                          ...
                          <td colspan="4" style="text-align:right"><font size="1"><?php echo $get->terbilang;?> &nbsp;
                                          <font size="1" style="text-align:right"><?php echo $get->terbilang2;?> &nbsp;
                                          <font size="1" style="text-align:right"><?php echo $get->terbilang3;?>
                          </td>
                        </tr>
                        <tr> 
            ...
            <table border="1">
              ...
              <?php foreach ($process_tax as $tampil) {?>
                ...
                <tr>
                  ...
                  <td><font size="1" style="text-align:right"><?php echo $tampil->dpp;?></td>
                  <td><font size="1" style="text-align:right"><?php echo $tampil->dpp_gross;?></td>
                  <td><font size="1" style="text-align:right"><?php echo $tampil->pajak_terutang;?></td>
