                    ...
                    <table border="1" width="100%">
                      ...
                      <tbody>                      
                        ...
                        <tr>
                          ...
                          <td><center> <font size="1"> <?php echo $get->currency;?>  <br> <?php echo $get->currency4;?> <br> <?php echo $get->currency8;?> </center></td>
                          <td><font size="1" ><?php echo $get->cash_advance; ?> <br> <?php echo $get->cash_advance2; ?> <br> <?php echo $get->cash_advance3; ?></td>
                        </tr>
                        <tr>
                          <td colspan="3"><font size="1"> (Negatif) = Piutang/<i>Receivable</i> atau Positif = Hutang/<i>Payable</i> </td>
                          <td><center> <font size="1"> <?php echo $get->currency;?>  <br> <?php echo $get->currency4;?> <br> <?php echo $get->currency8;?> </center></td>
                          <td><font size="1" ><?php echo $get->piutang; ?> <br><?php echo $get->piutang2; ?> <br> <?php echo $get->piutang3; ?></td>
                        </tr>
                        <tr> 
