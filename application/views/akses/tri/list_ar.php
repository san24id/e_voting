...
<div class="content-wrapper">
    ...
    <div class="box box-default">
        ...
        <!--<a href="tri/export_ar"><button class="btn btn-success"><i class="fa fa-download"></i>&nbsp;&nbsp;Export</button></a> -->
		&nbsp;&nbsp;&nbsp;
...
function resetdata()
    {
		...
		$('#periode1').val('');
		$('#periode2').val('');
		url = "<?php echo base_url('tri/resetMyReport') ?>";
      $.ajax({
            url : url,
            type: "POST",
 ...
 function caridata()
    {
	  url = "<?php echo base_url('tri/caridataMyReport') ?>";  //caridataAR
      $.ajax({
            url : url,
            type: "POST",
            data: $('#formCari').serialize(),
