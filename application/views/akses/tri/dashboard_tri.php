    ...
    <div class="row">        
          ...
          <div class="info-box bg-gray">
            ...
            <?php if ($start_date && $end_date){
              ...
              <a href="<?php echo base_url('Tri/all_detail_payment/1/'.$start_date.'/'.$end_date)?>"><span class="info-box-number"><font size='5' color="green"><center> <?php echo $tot_req->totalreq; ?></center></font></span></a>
              <?php } ?>    
          ...
          <div class="info-box bg-gray">
              ...
              <div class="info-box-content bg-gray">
                ...
                <a href="<?php echo base_url('Tri/all_detail_payment/2/'.$start_date.'/'.$end_date)?>"><span class="info-box-number"><font size='5' color="green"><center><?php echo $tot_outstanding->outstanding; ?></center></font></span></a>
                <?php } ?>            
            ...
            <?php foreach ($pembayaran as $key) { ?>
              {
                ...
                y: <?php echo $key->jmlpembayaran; ?>,
				        link:'<?php echo base_url('Tri/'.$key->link.'/'.$start_date.'/'.$end_date);?> '
              },
            <?php } ?>
              ]
      }]
