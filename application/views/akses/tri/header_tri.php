...
<div class="wrapper">
  <header class="main-header">
    ...
    <!-- Logo -->
    <a href="Tri" class="logo" style="background-image: url('assets/login/images/header1.png');background-repeat: no-repeat;
  ...
  <aside class="main-sidebar" style="background-image: url('assets/login/images/side_bar.png');">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">        
        ...
        <li><center><a href="Tri/form_add" target="_blank"><button type="button" class="btn btn-success btn-lg"><i class="glyphicon glyphicon-plus"></i>&nbsp;CREATE SP3</button></a></center></li>    
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>