                  ...
                  <div class="box-header with-border">
                    ...
                    <table style="font-family: calibri;" width="100%">
                      <tr>
                        ...
                        <td>
                          <input id="auto" type="checkbox" disabled> <b>Uang Muka/<i>Advance</i></b><br>
                        </td>
                        <td>
			...
			if (errmsg=="0"){
					if(lbl4[schk].checked && $('#text1').val()==""){
						...
						<?php foreach ($getID as $key) { ?>
						  var link = "<?php echo base_url('Tri/formfinished/'.$key->id_payment);?>";
						<?php } ?>
						  
						if(save_method=="edit"){
							url = "<?php echo base_url('Tri/saveeditpayment')?>";  
						}else{
							url = "<?php echo base_url('Tri/saveaddpayment')?>";  
						}
