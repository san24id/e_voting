              ...
              <div class="col-xs-12">
                ...
                <input type="hidden" name="id_user" value="<?php echo $row->id_user; ?>" >
                  <div class="box-header with-border">
					...
					<?php if ($row->jenis_pembayaran == 2 || $row->jenis_pembayaran == 4 || $row->jenis_pembayaran == 5 || $row->jenis_pembayaran == 6) { 
						$readonly="" ;
                    }else{
                          $readonly="readonly" ;
                    } ?>
					...
					<div id="show" class="table-responsive" <?php echo $showed; ?> >
					...
					<table style="font-family: calibri;" width="90%";>
                      ...
                      <tr>
                        ...
                        <td style="width:500px">
                          <select style="width:500px;height:32px" id="arf_number" name="label5"  class="form-control select2" onchange="chgarf(this.value)">
                        ...
                        <td>&nbsp;&nbsp;<input type="checkbox" id="chkarf" name="label6" value="Lampiran copy ARF tersedia"<?php echo $row->label6=="Lampiran copy ARF tersedia"? 'checked':''?> > Lampiran copy ARF tersedia</input></td>
                      </tr>
					  </tbody>
                    </table>
                    <table  style="font-family: calibri;" width="90%"; >
                      ...
                      <tr>
                        ...
                        <td colspan="2">&nbsp;</td>
                        <td>&nbsp;</td>
                        <td><input id="uangmuka" onkeyup="penjumlahan()" type="text" class="form-control" name="label8" value="<?php echo $row->label8; ?>" readonly></input> </td>     
						<td>&nbsp;</td>
                        <td><input id="uangmukaa" onkeyup="penjumlahana()" type="text" class="form-control" name="label8a" value="<?php echo $row->label8a; ?>" readonly></input></td>     
						<td>&nbsp;</td>
                        <td><input id="uangmukab" onkeyup="penjumlahanb()" type="text" class="form-control" name="label8b" value="<?php echo $row->label8b; ?>" readonly></input></td>     
                      </tr>
                      <tr>
...
function chgarf(param){
	...
	if (param){
		$.ajax({
		  url : "<?php echo base_url('approval/getdetilarf')?>/"+param,
		  type : "GET",
		  dataType: "JSON",
		...
		/*if (errmsg=="0"){
			...
			if (errmsg=="0"){
				...
				if (errmsg=="0"){
					...
					}else if ($.trim($('#jns_pembayaran').val())=="3" && $('#arf_number').val()==""){
...
function drpbank(param1,param2,param3){
	...
	function drpcurrency_old(param1){
	  ...
	  $("#scurrencyvendor"+param1).val($("#currencyvendor"+param1).val());
		...
		var itotal3=0;
		var inps = document.getElementsByName('nominalvendor[]');
		var inpscur = document.getElementsByName('scurrencyvendor[]');
		var curr1 = document.getElementById('Select').value;
		var curr2 = document.getElementById('currency2').value;
		var curr3 = document.getElementById('currency3').value;
		var kdv = document.getElementsByName('kodevendor[]');
