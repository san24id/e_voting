...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <font color="#00008B"><b>LIST OF DRAFT REQUEST</b></font>
      </h1>
    </section>
    ...
    <div class="box box-default">
        ...
        <!--<a href="approval/export_dr"><button class="btn btn-success"><i class="fa fa-download"></i>&nbsp;&nbsp;Export</button></a> -->
		&nbsp;&nbsp;&nbsp;
...
<script type="text/javascript">
		...
		$('#selblank').val('');
		url = "<?php echo base_url('approval/resetMyReportDraft') ?>";
      $.ajax({
            url : url,
            type: "POST",
	...
	function caridata(){
	  url = "<?php echo base_url('approval/caridataMyReportDraft') ?>"; //caridataDR
      $.ajax({
            url : url,
            type: "POST",
            data: $('#formCari').serialize(),
