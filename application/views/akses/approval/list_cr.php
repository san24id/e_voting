...
<div class="content-wrapper">
    ...
    <div class="box box-default">
        ...
        <!--<a href="approval/export_cr"><button class="btn btn-success"><i class="fa fa-download"></i>&nbsp;&nbsp;Export</button></a> -->
		&nbsp;&nbsp;&nbsp;
...
function resetdata()
 ...
 function caridata()
    {
	  url = "<?php echo base_url('approval/caridataMyReport') ?>"; //caridataCR
      $.ajax({
            url : url,
            type: "POST",
            data: $('#formCari').serialize(),
