...
<div class="content-wrapper">
    ...
    <div class="box box-default">
        ...
        <!--<a href="approval/export_op"><button class="btn btn-success"><i class="fa fa-download"></i>&nbsp;&nbsp;Export</button></a> -->
		&nbsp;&nbsp;&nbsp;
...
function resetdata()
    {
		...
		$('#selblank').val('');
		url = "<?php echo base_url('approval/resetMyReportOutstanding') ?>";
      $.ajax({
            url : url,
            type: "POST",
 ...
 function caridata()
    {
	  url = "<?php echo base_url('approval/caridataMyReportOutstanding') ?>"; //caridataOP
      $.ajax({
            url : url,
            type: "POST",
            data: $('#formCari').serialize(),
