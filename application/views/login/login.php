...
.wrap-login100 {
  ...
  background: #399996;
  background: -webkit-linear-gradient(top, #66ff66, #0099cc);
  background: -o-linear-gradient(top, #66ff66, #0099cc);
  background: -moz-linear-gradient(top, #66ff66, #0099cc);
  background: linear-gradient(top, #66ff66, #0099cc);
}
